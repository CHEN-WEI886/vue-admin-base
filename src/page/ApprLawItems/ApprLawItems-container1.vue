<template>
  <div 
    class="ApprLawItems-container1 center-content" 
  >
  
    <div class="tab">
      <div class="tab-item active">待审核 <span>6303</span></div>
      <div class="tab-item">已审核 <span>11</span></div>
